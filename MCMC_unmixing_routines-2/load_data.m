...
S = dlmread('O33E33A33.txt'); % *** Data (two columns matrix with wavelength and reflectance/SSA)
lam_SPEC = S(:,1);                   
R_SPEC = S(:,2);      
if min(lam_SPEC)>1
